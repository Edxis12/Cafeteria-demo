    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
        <div className="space-y-1">
          <label className="block text-[11px] font-semibold text-[#C5BCB3]">
            Nombre del Producto
          </label>
          <input
            type="text"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          <label className="flex items-center gap-3 cursor-pointer select-none">
            <input
              ...
              onChange={(e) => {
                ...
                if (e.target.checked)
                  setNewBadge(`Top #${newFeaturedOrder} Más Vendido`);
              }}
        ...
        <div className="p-4 rounded-2xl bg-[#1C1814] border border-[#2D2620] flex items-center justify-between">
          <label className="flex items-center gap-3 cursor-pointer select-none">
            ...
            <div>
              <span className="text-xs font-bold text-white flex items-center gap-1.5">
                <Sparkles size={14} className="text-[#D57E7E]" /> Lanzamiento de
                Temporada
              </span>

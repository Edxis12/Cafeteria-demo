...
export type ReservationStatus = "all" | "pending" | "confirmed" | "cancelled";
...
interface ReservationsTabProps {
  ...
  statusFilter: string;
  setStatusFilter: (f: ReservationStatus) => void;
  updateStatus: (id: string, status: string) => void;
}

const ITEMS_PER_PAGE = 10;

const STATUS_FILTERS: { id: ReservationStatus; label: string }[] = [
  { id: "all", label: "Todas" },
